 ...
 * @author Poppa
 */
public class CNWGroup 
{
    CNWGroup()
    {
        String URL = "http://www.newswire.ca/rss/en/search?N=58";
        ...
        for( int iItem = 1; iItem < items.length; iItem++)
        {
            ...
            */
            ...
            if( (tags.get( "language" ) != null && tags.get( "language" ).toString().startsWith( "en" ) == false) ||
                tags.get( "link" ).toString().contains( "/en/" ) == false )
            {
//                System.err.println( "<TR><TD COLSPAN='2'>Ignoring: language (" + tags.get( "language" ).toString() + ") not english</TD></TR>" );
                continue;
            }
